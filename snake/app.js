document.addEventListener('DOMContentLoaded', () => {
    ...
    let currentSnake = [2,1,0] //div in our grid being 2 (or the head), and 0 being the end (tail, with all 1's being the body from now on
    let direction = 1
    let score = 0
    let speed = 0.9
    let intervalTime = 0
    ...
    function control(e) {
        ...
        if(e.keyCode === 39) {
            ...
            direction = -1 //if we press left arrow, the snake will go left now
        } else if(e.keyCode === 40) {
            direction = +width //if we press down, snake head will instantly appear in the div 10 divs from where you are currently
        }
    }
